...
<body>
    ...
    * Alt: depende de la empresa: Logo de
    -->
    <div align="center">
        <img class="imagenes" src="img/nestle.png" alt="Logo de Nestle" width="300" height="300" >
    	<br>
    	<div class="container fluid">
    		<br>
    		<br>
			<p>
				Nestlé S.A. (pronunciación en francés: /nɛsle/) es una empresa multinacional suiza de alimentos y bebidas con sede en Vevey, Vaud, Suiza. Ha sido la empresa de alimentos más grande del mundo, medida por los ingresos y otras métricas, para 2014, 2015 y 2016. Se clasificó en el número 72 de la lista Fortune Global 500 en 2014 y en la edición 2016 de Forbes Global 2000 de las empresas públicas más grandes.
			</p>
			<!--
